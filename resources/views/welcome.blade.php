                            ...
                            <!-- <li><a href="{{ route('login') }}">Login</a></li>
                             ...
                             <li class="dropdown" style="opacity: 1.0 !important;" >
                               <a style="opacity: 1.0 !important; "href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                 <img src="{{asset(Auth::user()->profile->avatar)}}" alt="" width="30px" height="30px" style="border-radius: 50%;"> <span class="onName"style="margin-right:4px;margin-left: 3px;color: white;font-weight: 600;">{{Auth::user()->name}}</span><span class="caret"></span>
                              </a>
...
<div class="container">
   <div class="row">
      <div class="col-lg-12">
         ...
         <div class="flex-left full-height-2">
